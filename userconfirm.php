...
$row = mysqli_fetch_assoc($query);
	...
	?>
	 <div class="row">
	 <div class="col-md-4">
	<a href="chat/index.php?did=<?php echo $did?>"><button type="button"  class="btn btn-lg btn-warning">Chat with Driver</button></a>
	</div>
...
<button type="button" class="btn btn-lg btn-danger" data-toggle="modal" data-target="#exampleModalCenter" style="border-radius:50%">
  PANIC BUTTON
</button>
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title alert-danger" id="exampleModalLongTitle">Panic Button</h5>
