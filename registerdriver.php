...
if (isset($_POST['registerdriver'])) {
  ...
  if (count($errors) == 0) {
  	...
  	$query = "INSERT INTO driver (firstname,middlename,lastname, email, password) 
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="check-content">
                        ...
                        <h2 class="title yellow-color">Register as Driver Here</h2>
                        <h3 class="subtitle">Find Best Rental Car</h3>
                    </div><!-- /.check-content -->
                </div><!-- col-md-4 -->

                <div class="col-md-8">
                    <form  class="advance-search-query input-night-rider yellow-theme" action="registerdriver.php" method="post" autocomplete="off">
                        <div class="regular-search">                        
							...
							<?php include('errors.php'); ?>
							 ...
							 <div class="col-md-4">
                               ...
                               <button type="submit" class="button" name="registerdriver" value="registerdriver">REGISTER</button><br>
							    <label class="message">
  		  Not a Driver?<a href="registeruser.php#user"> Sign up as User</a><br>
